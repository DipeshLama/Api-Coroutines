...
import com.example.apicoroutines.feature.shared.viewHolder.CategoryViewHolder

class CategoryAdapter(val list: List<Category>) : RecyclerView.Adapter<CategoryAdapter.CategoryVH>() {
